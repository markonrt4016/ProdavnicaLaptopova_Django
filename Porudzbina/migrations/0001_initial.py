...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ProdavnicaLaptopova', '0001_initial'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('laptop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stavke_porudzbine_a', to='ProdavnicaLaptopova.laptop')),
